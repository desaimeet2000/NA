...
class DataValidation:
    ...
    def validate_numbers_of_columns(self, dataframe: pd.DataFrame):
        try:
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        try:
            ...
            train_dataframe = DataValidation.read_data(valid_train_file_path)
            test_dataframe = DataValidation.read_data(valid_test_file_path)
